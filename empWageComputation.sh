...
<<<<<<< HEAD
>>>>>>> empDailyWageTotalWage
=======

## Employee Wage for daily with total wage ##
...
## End of Employee Wage for daily with total wage ##
>>>>>>> empDailyWageWithTotalWage
